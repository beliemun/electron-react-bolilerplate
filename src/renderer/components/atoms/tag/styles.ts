...
export const tagStyles = ({ tagStyle, tagSize, tagColor }: TagProps) => {
  ...
  if (tagStyle === 'solid') {
    ...
    if (tagColor === 'primary') {
      styles.push(
        'text-primary-800 bg-primary-100 dark:text-white dark:bg-primary-800/50',
      );
    } else if (tagColor === 'gray') {
      styles.push(
        'text-gray-800 bg-gray-100 dark:text-white dark:bg-gray-800/50',
      );
    } else if (tagColor === 'slate') {
      styles.push(
      ...
      styles.push(
        'text-orange-800 bg-orange-100 dark:text-white dark:bg-orange-800/50',
      );
    } else if (tagColor === 'yellow') {
      styles.push(
        'text-yellow-800 bg-yellow-100 dark:text-white dark:bg-yellow-800/50',
      );
    } else if (tagColor === 'lime') {
      styles.push(
        'text-lime-800 bg-lime-100 dark:text-white dark:bg-lime-800/50',
      );
    } else if (tagColor === 'green') {
      styles.push(
        'text-green-800 bg-green-100 dark:text-white dark:bg-green-800/50',
      );
    } else if (tagColor === 'emerald') {
      styles.push(
        'text-emerald-800 bg-emerald-100 dark:text-white dark:bg-emerald-800/50',
      );
    } else if (tagColor === 'teal') {
      styles.push(
        'text-teal-800 bg-teal-100 dark:text-white dark:bg-teal-800/50',
      );
    } else if (tagColor === 'cyan') {
      styles.push(
        'text-cyan-800 bg-cyan-100 dark:text-white dark:bg-cyan-800/50',
      );
    } else if (tagColor === 'blue') {
      styles.push(
        'text-blue-800 bg-blue-100 dark:text-white dark:bg-blue-800/50',
      );
    } else if (tagColor === 'violet') {
      styles.push(
        'text-violet-800 bg-violet-100 dark:text-white dark:bg-violet-800/50',
      );
    } else if (tagColor === 'purple') {
      styles.push(
        'text-purple-800 bg-purple-100 dark:text-white dark:bg-purple-800/50',
      );
    } else if (tagColor === 'pink') {
      styles.push(
        'text-pink-800 bg-pink-100 dark:text-white dark:bg-pink-800/50',
      );
    } else if (tagColor === 'rose') {
      styles.push(
        'text-rose-800 bg-rose-100 dark:text-white dark:bg-rose-800/50',
      );
    }
  }
  if (tagSize === 'sm') {
    styles.push('inline-block text-[18px] px-2 py-1 rounded-md');
  } else if (tagSize === 'default') {
    styles.push('inline-block text-[22px] px-4 py-1 rounded-lg');
  }
  return styles.join(' ');
};
